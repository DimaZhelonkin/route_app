...
//                 return Result.Error("Validations_UseDifferentPassword");
//
...
//             }
//
//             return Result.Error("Unable to change user password.");
//         }
//         catch (Exception ex)
//         {
//             var errorMessage = "Error while trying to change user password.";
//             _logger.LogError(ex, errorMessage);
//             return Result.Error(errorMessage);
//         }
//     }
...
//                 applicationUser.PhoneNumber = request.PrimaryPhoneNumber;
//
//             if (!string.IsNullOrWhiteSpace(request.SecondaryPhoneNumber) &&
