...
namespace Ark.IdentityServer.Domain.ApplicationUser.ValueObjects;
...
public sealed class FirstName : ValueObject
{
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="ValueObjects.FirstName" /> class.
    /// </summary>
    /// <param name="value"> first name value.</param>
    ...
    public static implicit operator FirstName(string firstName) => Create(firstName).ThrowIfFailure().Value!;

    public static implicit operator string(FirstName firstName) => firstName.Value;

    /// <summary>
    ///     Creates a new <see cref="ValueObjects.FirstName" /> instance based on the specified value.
    /// </summary>
