namespace Ark.Application.Enums;

public enum BranchPointTypeEnum
{
    /// <summary>
    ///     An out-of-order event is one that's received late, sufficiently late that you've already processed events that
    ///     should have been processed after the out-of-order event was received.
    ...
    ///     For incorrect events we reverse the original event and mark it as rejected. We insert the retroactive event and
    ///     process it.
