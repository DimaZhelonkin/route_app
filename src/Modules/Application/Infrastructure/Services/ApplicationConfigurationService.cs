...
namespace Ark.Application.Services;
...
internal class ApplicationConfigurationService : IApplicationConfigurationService
{
    ...
    public async Task<Result> Create(ApplicationConfigurationDto dto)
    {
        ...
        catch (Exception ex)
        {
            ...
            return Result.Error("ApplicationConfigurationService.Create",
                "Error while trying to create application configuration");
        }
    }
    ...
    public async Task<Result<ApplicationConfigurationDto>> Details(string id, bool decrypt)
    {
        ...
        catch (Exception ex)
        {
            ...
            return Result.Error<ApplicationConfigurationDto>("ApplicationConfigurationService.Details", errorMessage);
        }
    }
    ...
    public async Task<Result> Edit(ApplicationConfigurationDto dto)
    {
        try
        {
            ...
            await _appConfigRepository.UpdateAsync(updatedEntity);
            await _appConfigRepository.UnitOfWork.SaveChangesAsync();
        ...
        catch (Exception ex)
        {
            ...
            _logger.LogError(ex, errorMessage);
            return Result.Error("ApplicationConfigurationService.Edit", errorMessage);
        }
    }
    ...
    public async Task<Result<bool>> Delete(string id)
    {
        ...
        catch (Exception ex)
        {
            ...
            _logger.LogError(ex, errorMessage);
            return Result.Error<bool>("ApplicationConfigurationService.Delete", errorMessage);
        }
    }
    ...
    public async Task<Result<string>> GetValue(string key)
    {
        ...
        catch (Exception ex)
        {
            ...
            _logger.LogError(ex, errorMessage);
            return Result.Error<string>("ApplicationConfigurationService.GetValue", errorMessage);
        }
    }
    ...
    public async Task<Result<int>> GetValueInt(string key)
    {
        ...
        catch (Exception ex)
        {
            var errorMessage = "Error while trying to retrieve application configuration value";
            _logger.LogError(ex, errorMessage);
            return Result.Error<int>("ApplicationConfigurationService.GetValueInt", errorMessage);
        }
    }
    ...
    public async Task<Result<bool>> GetValueBool(string key)
    {
        ...
        catch (Exception ex)
        {
            ...
            _logger.LogError(ex, errorMessage);
            return Result.Error<bool>("ApplicationConfigurationService.GetValueBool", errorMessage);
        }
    }
    ...
    public async Task<Result<DateTimeOffset>> GetValueDateTime(string key)
    {
        ...
        catch (Exception ex)
        {
            var errorMessage = "Error while trying to retrieve application configuration value";
            _logger.LogError(ex, errorMessage);
            return Result.Error<DateTimeOffset>("ApplicationConfigurationService.GetValueDateTime", errorMessage);
        }
    }

    public async Task<Result<string[]>> GetMultiple(string key) => await GetMultiple(key, MULTIPLE_VALUE_DELIMITER);
    ...
    public async Task<Result<string[]>> GetMultiple(string key, string delimiter)
    {
        try
        {
            ...
            if (!valueResult.IsSuccess)
                Result.Error("ApplicationConfigurationService.GetMultiple", "Unable to fetch multiple keys from");
            return Result.Success(valueResult.Value.Split(delimiter));
        }
        catch (Exception ex)
        {
            var errorMessage = "Error while trying to retrieve application configuration value";
            _logger.LogError(ex, errorMessage);
            return Result.Error<string[]>("ApplicationConfigurationService.GetMultiple", errorMessage);
        }
    }
